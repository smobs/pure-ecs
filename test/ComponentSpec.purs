...
import ECS.World (World, emptyWorld, hasEntity, spawnEntity, unEntity)
  ...
  describe "ECS.Component" do
    ...
    describe "Adding Components" do
      ...
      it "multiple entities can have same components" do
        let world = emptyWorld
            ...
            {world: w3, entity: e1'} = addComponent _position {x: 10.0, y: 20.0} e1 w2
            {world: w4, entity: e2'} = addComponent _position {x: 5.0, y: 15.0} e2 w3
      ...
      it "adding three components works" do
        let world = emptyWorld
            ...
            {world: w2, entity: e2} = addComponent _position {x: 10.0, y: 20.0} e1 w1
            {world: w3, entity: e3} = addComponent _velocity {x: 1.0, y: 0.0} e2 w2
            {world: w4, entity: e4} = addComponent _health {current: 100, max: 100} e3 w3
    ...
    describe "Removing Components" do
      ...
      it "removes component from entity" do
        let world = emptyWorld
            {world: w1, entity: e1} = spawnEntity world
            {world: w2, entity: e2} = addComponent _position {x: 10.0, y: 20.0} e1 w1
            {world: w3, entity: e3} = removeComponent _position e2 w2
        hasEntity e3 w3 `shouldEqual` true
      ...
      it "removes middle component preserves others" do
        let world = emptyWorld
            ...
            {world: w3, entity: e3} = addComponent _velocity {x: 1.0, y: 0.0} e2 w2
            {world: w4, entity: e4} = addComponent _health {current: 100, max: 100} e3 w3
            {world: w5, entity: e5} = removeComponent _velocity e4 w4
    ...
    describe "Getting Components" do
      ...
      it "get existing component returns Just" do
        let world = emptyWorld
            {world: w1, entity: e1} = spawnEntity world
            {world: w2, entity: e2} = addComponent _position {x: 10.0, y: 20.0} e1 w1
            maybePos = getComponent _position e2 w2
        case maybePos of
      ...
      it "get component returns correct value" do
        let world = emptyWorld
            {world: w1, entity: e1} = spawnEntity world
            {world: w2, entity: e2} = addComponent _velocity {x: 5.0, y: -3.0} e1 w1
            maybeVel = getComponent _velocity e2 w2
        case maybeVel of
          Just vel -> do
      ...
      it "get from entity with multiple components" do
        let world = emptyWorld
            ...
            {world: w2, entity: e2} = addComponent _position {x: 10.0, y: 20.0} e1 w1
            {world: w3, entity: e3} = addComponent _velocity {x: 1.0, y: 0.0} e2 w2
            maybePos = getComponent _position e3 w3
            maybeVel = getComponent _velocity e3 w3
    ...
    describe "Archetype Migration" do
      ...
      it "entity moves between archetypes on add" do
        let world = emptyWorld
            {world: w1, entity: e1} = spawnEntity world  -- "" archetype
            {world: w2, entity: e2} = addComponent _position {x: 10.0, y: 20.0} e1 w1  -- "position" archetype
        hasEntity e2 w2 `shouldEqual` true
      ...
      it "entity moves between archetypes on remove" do
        let world = emptyWorld
            {world: w1, entity: e1} = spawnEntity world
            {world: w2, entity: e2} = addComponent _position {x: 10.0, y: 20.0} e1 w1
            {world: w3, entity: e3} = removeComponent _position e2 w2  -- back to "" archetype
        hasEntity e3 w3 `shouldEqual` true
      ...
      it "multiple entities share archetypes" do
        let world = emptyWorld
            ...
            {world: w3, entity: e1'} = addComponent _position {x: 1.0, y: 2.0} e1 w2
            {world: w4, entity: e2'} = addComponent _position {x: 3.0, y: 4.0} e2 w3
        hasEntity e1' w4 `shouldEqual` true
        hasEntity e2' w4 `shouldEqual` true
    ...
    describe "Multiple Components" do
      ...
      it "component values are preserved across additions" do
        let world = emptyWorld
            {world: w1, entity: e1} = spawnEntity world
            {world: w2, entity: e2} = addComponent _position {x: 10.0, y: 20.0} e1 w1
            {world: w3, entity: e3} = addComponent _velocity {x: 5.0, y: -2.0} e2 w2
            pos = getComponent _position e3 w3
            vel = getComponent _velocity e3 w3
        case pos, vel of
          Just p, Just v -> do
    ...
    describe "Edge Cases" do
      ...
      it "add and remove same component works" do
        let world = emptyWorld
            ...
            pos = getComponent _position e4 w4
        case pos of
...
addMultiple n world =
  let {world: w1, entity: e1} = spawnEntity world
      {world: w2, entity: _} = addComponent _position {x: 0.0, y: 0.0} e1 w1
